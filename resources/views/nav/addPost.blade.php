       ...
       <form method="post" action="{{ route('add') }}" enctype="multipart/form-data"> 
            ...
            <div class="row">
                <div class="form-group">
                  <textarea class="form-control" rows="3" id="short" required="required" name="short" placeholder="Short Description"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="form-group">
                  <textarea class="form-control" rows="9" required="required" name="txt" placeholder="The Post"></textarea>
                </div>
            </div>
